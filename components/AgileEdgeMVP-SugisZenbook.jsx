...
const RegistrationDetailsForm = memo(({ form, handleFormChange, corpEmails, handleCorpEmailChange, handleRemoveCorpEmail, waitlistMode, setStep, setCorpEmails, googleUser, onGoogleSuccess }) => (
  <div>
    ...
    {/* Google sign-in */}
    {googleUser ? (
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#F0FDF4', border: '1px solid #86EFAC', borderRadius: 10, padding: '10px 14px', marginBottom: 24 }}>
